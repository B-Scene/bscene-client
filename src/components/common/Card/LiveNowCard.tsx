    ...
    <article className={`${cardClassName} relative`}>
      <div className="relative h-[62px] w-[62px] shrink-0 rounded-full shadow-[0_0_18px_rgb(240_69_121_/80%)]">
        <img
          ...
          src={imageSrc}
        />
        <span className="font-body text-label4 absolute bottom-[-2px] left-1/2 inline-flex h-[12px] w-[27px] -translate-x-1/2 items-center justify-center rounded-full bg-primary-400 text-neutral-0">
          {liveBadgeSrc ? (
            <img
              alt={liveBadgeAlt}
      ...
      <div className="ml-[10px] min-w-0 flex-1 pr-[66px]">
        ...
        <p className="font-body text-caption2 m-0 mt-[4px] flex items-center gap-[6px] truncate text-primary-400">
          {listenerIconSrc ? (
            <img
              alt={listenerIconAlt}

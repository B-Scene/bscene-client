...
export const compactBandCardClassName =
  'box-border flex h-[86px] w-full items-center gap-[10px] rounded-[16px] bg-neutral-0 px-[16px] py-[12px] text-left shadow-[0_4px_8px_rgb(20_20_20_/10%)]'

export const listCardClassName =
  'box-border flex h-[86px] w-full items-center rounded-[16px] bg-neutral-0 px-[16px] py-[12px] text-left shadow-[0_4px_8px_rgb(20_20_20_/10%)]'

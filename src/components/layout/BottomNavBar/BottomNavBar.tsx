...
export const BottomNavBar = ({
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 mx-auto flex h-(--bottom-nav-height) w-full max-w-[393px] items-center justify-between bg-neutral-0 px-[clamp(0.75rem,4vw,1.875rem)] py-4 shadow-[0_-5px_20px_0_rgba(0,0,0,0.03)]">
      {tabs.map((tab) => {

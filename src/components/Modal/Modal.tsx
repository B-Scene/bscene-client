...
const Modal = ({
  ...
  return (
    <section
      aria-modal="true"
      // min-h-[184px] 제거 : 콘텐츠가 짧을 때 justify-content가 없어 남는 공간이 전부 버튼 아래로 몰려 빈 여백처럼 보임
      className="box-border flex w-[313px] max-w-full flex-col items-center bg-neutral-0 px-[32px] py-[24px] text-center"
      role="dialog"
    >
      <div className="flex flex-col items-center gap-[10px]">
        <h3 className="font-body text-label1 m-0 text-neutral-900">{title}</h3>
